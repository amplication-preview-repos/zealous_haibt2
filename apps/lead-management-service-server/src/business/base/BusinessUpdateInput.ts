...
class BusinessUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProfessionalUpdateManyWithoutBusinessesInput,
  })
  @ValidateNested()
  @Type(() => ProfessionalUpdateManyWithoutBusinessesInput)
  @IsOptional()
  @Field(() => ProfessionalUpdateManyWithoutBusinessesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ProspectUpdateManyWithoutBusinessesInput,
  })
  @ValidateNested()
  @Type(() => ProspectUpdateManyWithoutBusinessesInput)
  @IsOptional()
  @Field(() => ProspectUpdateManyWithoutBusinessesInput, {
    nullable: true,
  })
