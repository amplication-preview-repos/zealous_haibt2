...
@InputType()
class ProfessionalCreateNestedManyWithoutBusinessesInput {
...
export { ProfessionalCreateNestedManyWithoutBusinessesInput as ProfessionalCreateNestedManyWithoutBusinessesInput };
