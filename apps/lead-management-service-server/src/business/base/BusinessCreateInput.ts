...
class BusinessCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProfessionalCreateNestedManyWithoutBusinessesInput,
  })
  @ValidateNested()
  @Type(() => ProfessionalCreateNestedManyWithoutBusinessesInput)
  @IsOptional()
  @Field(() => ProfessionalCreateNestedManyWithoutBusinessesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ProspectCreateNestedManyWithoutBusinessesInput,
  })
  @ValidateNested()
  @Type(() => ProspectCreateNestedManyWithoutBusinessesInput)
  @IsOptional()
  @Field(() => ProspectCreateNestedManyWithoutBusinessesInput, {
    nullable: true,
  })
