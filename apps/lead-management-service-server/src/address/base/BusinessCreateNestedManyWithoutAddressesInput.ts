...
@InputType()
class BusinessCreateNestedManyWithoutAddressesInput {
...
export { BusinessCreateNestedManyWithoutAddressesInput as BusinessCreateNestedManyWithoutAddressesInput };
